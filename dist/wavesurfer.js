/*!
 * wavesurfer.js 4.4.0 (2021-01-27)
                        ...
                        _createClass(MediaElement, [
                            ...
                            },
                            {
                                ...
                                value: function _setupMediaListeners() {
                                    ...
                                    this.mediaListeners.volumechange = function (
                                        event
                                    ) {
                    ...
                    function fetchFile(options) {
                        ...
                        fetch(fetchRequest, fetchOptions)
                            .then(function (response) {
                                ...
                                var contentLength = response.headers.get(
                                    "content-length"
                                );
                        ...
                        _createClass(WaveSurfer, [
                            ...
                            },
                            {
                                ...
                                value: function seekTo(progress) {
                                    ...
                                    var oldScrollParent = this.params
                                        .scrollParent;
                            ...
                            },
                            {
                                ...
                                value: function toggleInteraction() {
                                    this.params.interact = !this.params
                                        .interact;
                                },
                                /**
                            ...
                            },
                            {
                                ...
                                value: function getPeaks(length, first, last) {
                                    ...
                                    for (c = 0; c < channels; c++) {
                                        ...
                                        var chan = this.buffer.getChannelData(
                                            c
                                        );
                                        var i = void 0;
